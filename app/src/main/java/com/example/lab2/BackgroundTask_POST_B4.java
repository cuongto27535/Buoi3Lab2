...
public class BackgroundTask_POST_B4 extends AsyncTask<String, Void, Void> {
    ...
    public BackgroundTask_POST_B4(Context context, TextView tvResult, String strA, String strB, String strC) {
